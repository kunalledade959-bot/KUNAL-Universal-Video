...
if not p.is_file(): raise SystemExit('STAGE 11 V3: activity_fixed.kt missing')
a=p.read_text(encoding='utf-8')
start=a.find('    private fun muxVideoAudio(')
end=a.find('    private fun verifyAndFix()',start)
if start<0 or end<0: raise SystemExit('STAGE 11 V3: media assembly block not found')
...
if old not in a: raise SystemExit('STAGE 11 V3: assemble gate target not found')
a=a.replace(old,new,1)
p.write_text(a,encoding='utf-8')
print('STAGE 11 V3: PASS')
